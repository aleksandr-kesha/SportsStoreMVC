...
namespace SportsStore.Tests.Controllers
{
    ...
    public class ProductsControllerTests
    {
        ...
        [TestMethod]
        public void GenerateSpecificCategoryProductCount()
        {
            var mock = new Mock<IProductRepository>();
            ...
            var res1 = ((ProductListViewModel) target.List("Cat1").Model).PagingInfo.TotalItems;
            var res2 = ((ProductListViewModel)target.List("Cat2").Model).PagingInfo.TotalItems;
            var res3 = ((ProductListViewModel)target.List("Cat3").Model).PagingInfo.TotalItems;

            var res = ((ProductListViewModel)target.List(null).Model).PagingInfo.TotalItems;
